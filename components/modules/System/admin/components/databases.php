...
if (isset($Config->routing['current'][2])) {
	...
	$db_list =	$a->tr(
					$a->td(
						...
						array('style' => 'text-align: center; vertical-align: middle;', 'class' => 'greybg1 white')
					)
				).
				$a->tr(
					$a->td(
						...
						array('style' => 'text-align: center; vertical-align: middle;', 'class' => 'greybg2 green')
					)
				);
		...
		if (is_array($mirror) && !empty($mirror)) {
			$db_list .=	$a->tr(
							$a->td(
								...
								array('style' => 'text-align: center; vertical-align: middle;', 'class' => 'greybg3')
							)
						);
		}
	}
		...
		if (is_array($db) && !empty($db) && $i) {
			$db_list .=	$a->tr(
							$a->td(
								...
								array('style' => 'text-align: center; vertical-align: middle;', 'class' => 'greybg2')
							)
						);
