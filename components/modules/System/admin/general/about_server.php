				...
				$a->table(
					$a->tr(
						array(
							...
							$a->td('magic_quotes_gpc:').$a->td($L->__get(get_magic_quotes_gpc()), array('class' => !get_magic_quotes_gpc() ? 'green' : 'red')),
							...
							$a->td('register_globals:').$a->td($L->__get(register_globals()), array('class' => !register_globals() ? 'green' : 'red'))
						)
					),
					array('class' => 'left_odd', 'style' => 'width: 100%;')
				)
