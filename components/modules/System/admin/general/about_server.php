			...
			$a->td(
				$a->table(
					...
					$a->tr(
						...
						$a->td($db->core->server().(!check_db() ? ' ('.$L->required.' '.$$DB_TYPE.' '.$L->or_higher.')' : ''), array('class' => check_db() ? 'green' : 'red'))
					).
					$a->tr(
						$a->td($L->name_of_db.':').
						$a->td($DB_NAME)
			...
			$a->td(
				$a->table(
					$a->tr(
						...
						$a->td($L->__get(ini_get('file_uploads')), array('class' => ini_get('file_uploads') ? 'green' : 'red'))
					).
					$a->tr(
					...
					$a->tr(
						...
						$a->td($L->__get(get_magic_quotes_gpc()), array('class' => !get_magic_quotes_gpc() ? 'green' : 'red'))
					).
					$a->tr(
						$a->td($L->allow_url_fopen.':').
						$a->td($L->__get(ini_get('allow_url_fopen')), array('class' => ini_get('allow_url_fopen') ? 'green' : 'red'))
					).
					$a->tr(
						$a->td($L->display_errors.':').
						$a->td($L->__get(display_errors()), array('class' => display_errors() ? 'green' : 'red'))
					).
					$a->tr(
