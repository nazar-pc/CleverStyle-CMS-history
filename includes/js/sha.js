 ...
 * Modified by Nazar Mokrynskyi for supporting utf-8 input string
 */
(function ()
{
	/*
	...
	{
		srcString = unescape(encodeURIComponent(srcString));
		this.sha1 = null;
		this.sha224 = null;
		this.sha256 = null;
		this.sha384 = null;
	...
	jsSHA.prototype = {
		...
		getHash : function (variant, format)
		{
			...
			case "sha224":
				if (null === this.sha224)
				{
					this.sha224 = coreSHA2(message, this.strBinLen, "SHA-224");
				}
			...
			case "sha256":
				if (null === this.sha256)
				{
					this.sha256 = coreSHA2(message, this.strBinLen, "SHA-256");
				}
			...
			case "sha384":
				if (null === this.sha384)
				{
					this.sha384 = coreSHA2(message, this.strBinLen, "SHA-384");
				}
			...
			case "sha512":
				if (null === this.sha512)
				{
					this.sha512 = coreSHA2(message, this.strBinLen, "SHA-512");
				}
