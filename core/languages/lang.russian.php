...
//Информация о сайте
	...
	'url'							=> 'Адрес',
	'url_info'						=> 'Адрес, по которому доступен ваш сайт. Адрес не должен содержать конечного слеша, но должен иметь префикс http:// или https://<br><br>ВНИМАНИЕ: если вы опытный администратор, и ваш адрес сайта каким-то образом ссылается на несколько IPv4 или IPv6 адресов (например, при балансировке нагрузки), для того, чтобы система могла различать физические расположения сайтов, укажите через точку с запятой все IP адреса (конечная точка с запятой не нужна).<br>Пример:<br>http://example.com;123.456.789.123;234.567.891.123;1234:4567:abcd::1<br><br>ВНИМАНИЕ: для IP адресов нужно создавать конфигурационные файлы, как и для других зеркал.',
	...
	'mirrors_url'					=> 'Адреса',
	'mirrors_url_info'				=> 'Адреса, по которым этот сайт также будет доступен, по одному адресу на строку.<br>Адрес не должен содержать конечного слеша, но должен иметь префикс http:// или https://<br><br>ВНИМАНИЕ: если вы опытный администратор, и есть адреса, которые каким-то образом ссылаются на несколько IPv4 или IPv6 адресов (например, при балансировке нагрузки), для того, чтобы система могла различать физические расположения этих сайтов, укажите через точку с запятой все IP адреса (конечная точка с запятой не нужна).<br>Пример:<br>http://example.com;123.456.789.123;234.567.891.123;1234:4567:abcd::1<br><br>ВНИМАНИЕ: для IP адресов нужно создавать конфигурационные файлы, как и для других зеркал.',
