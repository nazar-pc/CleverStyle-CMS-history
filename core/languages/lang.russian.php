...
//Кеширование
	...
	'disk_cache_size_info'			=> 'Ограничивает размер файлового кеша.<br>ВНИМАНИЕ: размер кеша не должен превышать объем свободного пространства на винчестере!<br>ВНИМАНИЕ: слишком маленькое значение размера кеша лишь приведёт к нерациональной сверхнагрузки на файловую систему без ощутимой выгоды.',
	'memcache'						=> 'Memcache',
