...
//Система
	...
	'show_queries_extended' => 'Показать расширенную информацию о запросах',
	'show_cookies' => 'Показать cookies',
	'show_user_data' => 'Показать данные пользователя',
	'show_objects_data' => 'Показать данные об загруженных объектах',
...
//Тексты ошибок
	...
	'db_already_exists' => 'БД с таким именем уже существует'
);
?>