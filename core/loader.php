...
define('CACHE', CORE.'/cache/'.DOMAIN);			//Папка с кешем
define('CLASSES', CORE.'/classes');				//Папка с классами
define('CONFIG', CORE.'/config');				//Папка конфигурации
...
define('PCACHE', DIR.'/includes/cache');		//Папка с публичным кешем (доступным пользователю извне)
