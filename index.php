...
define('MICROTIME', microtime(true)-date('Z'));	//Время в секундах (с плавающей точкой)
define('TIME', round(MICROTIME));						//Время в секундах (целое число)
$timeload['start'] = MICROTIME;

//Убиваем небезопасные глобальные переменные, использование GET метода не допускается, только POST
unset(
